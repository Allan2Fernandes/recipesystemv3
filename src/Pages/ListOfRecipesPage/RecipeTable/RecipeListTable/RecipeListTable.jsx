...
function RecipeListTable(props){
    ...
    async function saveDuplicatedRecipe(duplicatedRecipeName, selectedRecipeSetID){
        var recipeData
        ...
        var saveRecipeNameParams = `${recipeNameParamID};${duplicatedRecipeName};`
                    ...
                    if(listOfSubStepSaveQueries.length!==0){
                        FetchQueries.executeQueryInDatabase(listOfSubStepSaveQueries)
                            .then(r => {
                                ...
                                //navigate(`/RecipeStepsPage/RecipeSetID/${newRecipeSetID}/RecipeName/${duplicatedRecipeName}/UrlSelectedStepIndex/-1/ReadOnly/${false}`)
                            })
                            .catch(e => {
                                console.log(e)
    ...
    function handleClickDuplicateRecipe(recipeSetID){
